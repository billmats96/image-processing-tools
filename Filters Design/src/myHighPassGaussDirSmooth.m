function filtOut = myHighPassGaussDirSmooth(sigma, M, theta, phi, avgFilterType, MS, sigmaG)
%myHighPassGaussDirSmooth - Implements a smooth directional High Pass Gauss filter in Frequency Domain
%
% SYNTAX
%
%   filtOut = myHighPassGaussDirSmooth(sigma, M, theta, phi, 
...
% DESCRIPTION
%
%   myHighPassGaussDirSmooth uses myHighPassGaussDir to create 
%   a directional Gauss High Pass filter and then applies an
