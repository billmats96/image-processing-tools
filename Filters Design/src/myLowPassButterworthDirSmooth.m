function filtOut = myLowPassButterworthDirSmooth(cutOff, n, M, theta, phi, avgFilterType, MS, sigmaG)
%myLowPassButterworthDirSmooth - Implements a smooth directional Low Pass Butterworth filter in Frequency Domain
%
% SYNTAX
%
%   filtOut = myLowPassButterworthDirSmooth(cutOff , n, M, theta, phi, 
...
% DESCRIPTION
%
%   myLowPassButterworthDirSmooth uses myLowPassButterworthDir to create 
%   a directional Butterworth Low Pass filter and then applies an
