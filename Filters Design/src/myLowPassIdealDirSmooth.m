function filtOut = myLowPassIdealDirSmooth(cutOff, M, theta, phi, avgFilterType, MS, sigmaG)
%myLowPassIdealDirSmooth - Implements an ideal smooth directional Low Pass filter in Frequency Domain
%
% SYNTAX
%
%   filtOut = myLowPassIdealDirSmooth(cutOff, M, theta, phi, avgFilterType, 
...
% DESCRIPTION
%
%   myLowPassIdealDirSmooth uses myLowPassIdealDir to create 
%   an ideal directional Low Pass filter and then applies an
